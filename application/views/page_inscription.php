...
<html lang="fr">
<head>
	<link rel="stylesheet" type="text/css" href="<?= base_url('css/page_inscription.css')?>">          <!--liaison avec le css correspondant-->
    <meta charset="UTF-8">
...
<!--<a href="page_accueil.php" class="bouton">Retour</a>    -->         <!--liaison avec la page d'accueil via un bouton-->
    <div class="inscription">
		...
		?>
		<img src="<?= base_url('images/user.png')?>" alt="" height="100">          <!--liaison avec l'image présente sur la page-->
		<?= form_open('utilisateur/newUser'); ?>               <!--envoi vers l'index pour exécuter les différentes fonctions de l'index en lien avec la page-->
